...
$(document).ready(function () {
    ...
    var $headerTopbar = $(".header__topbar").clone().addClass("header__topbar--mob");
    ...
    (zoomFunc = function zoomFunc() {
        ...
        $zoomImg.each(function (index) {
            ...
            if (window.innerWidth > 767) {
                ...
                $(".zoomResult").css({ top: _pos.top, left: _rightPos, width: _width, height: _width });
    ...
    if ($(".product").length > 0) {
        var $pSettings = $(".promotion__settings").clone().addClass("promotion__settings--mob");
        if (window.innerWidth < 768) {
    ...
    $("#cities-select").on("show.bs.select", function (e, clickedIndex, isSelected, previousValue) {
